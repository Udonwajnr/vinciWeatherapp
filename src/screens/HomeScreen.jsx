...
const HomeScreen =()=>{
    ...
    return(
        <View className="flex-1 relative">
            <Text className="text-green-300">I love you soo much</Text>
                ...
                (
                    <SafeAreaView className="flex flex-1">
                        ...
                        <View style={{height:"7%"}} className="mx-4 relative z-50" >
                            <View style={{backgroundColor:showSearch?theme.bgWhite(0.2):"transparent"}} className="flex-row justify-end item-center rounded-full">
                                    ...
                                    <View className="absolute w-full bg-gray-300 top-16 rounded-3xl">
                                        {
                                            locations.map((loc,index)=>{
                                                ...
                                                return(
                                                    ...
                                                    className={`flex-ro2 items-center border-0 px-4 mb-1 + ${borderClass}`}
                        ...
                        <View className="flex-row justify-between mx-4">
                            <View className="flex-row space-x-2 items-center">
                                <Image source={require('../assets/images/wind3.png')} className="h-6 w-6"/>
